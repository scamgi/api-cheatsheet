...
% --- Layout e stile ---
\usepackage[a4paper, margin=1.5cm]{geometry} % Aumentato leggermente il margine per sicurezza
...
\usepackage{fancyhdr}      % Pacchetto per gestire header/footer
\usepackage{listings}

% --- Configurazione fancyhdr ---
\pagestyle{fancy}          % Applica lo stile fancy a tutto il documento
\fancyhf{}                 % Pulisce tutte le intestazioni e i piè di pagina
\renewcommand{\headrulewidth}{0pt} % Rimuove la linea dell'intestazione
\cfoot{\thepage}           % Imposta il numero di pagina al centro del footer (cfoot)
